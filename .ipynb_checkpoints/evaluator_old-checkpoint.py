...
This module evaluates an Intrusion Detection model by computing both standard classification metrics and the time an attack remains undetected. The evaluation includes the following key metrics:
...
These metrics are meaningful only if the dataset consists of sequences containing both normal and anomalous operations.
